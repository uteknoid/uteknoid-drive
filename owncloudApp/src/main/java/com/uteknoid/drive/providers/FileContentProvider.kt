...
import com.uteknoid.drive.data.Executors
import com.uteknoid.drive.data.OwncloudDatabase
import com.uteknoid.drive.data.ProviderMeta
import com.uteknoid.drive.data.capabilities.datasources.implementation.OCLocalCapabilitiesDataSource
import com.uteknoid.drive.data.capabilities.datasources.implementation.OCLocalCapabilitiesDataSource.Companion.toModel
...
import com.uteknoid.drive.data.migrations.CameraUploadsMigrationToRoom
...
import com.uteknoid.drive.db.ProviderMeta.ProviderTableMeta
import com.uteknoid.drive.domain.files.LIST_MIME_DIR
...
class FileContentProvider(val executors: Executors = Executors()) : ContentProvider() {
     ...
     *
     * See [com.uteknoid.drive.authentication.AccountUtils.updateAccountVersion]
     *
