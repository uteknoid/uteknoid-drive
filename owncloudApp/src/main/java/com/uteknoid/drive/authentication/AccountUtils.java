...
import com.uteknoid.drive.lib.common.accounts.AccountUtils.Constants;
import com.uteknoid.drive.lib.resources.status.OwnCloudVersion;
import timber.log.Timber;

import java.util.Locale;

import static com.uteknoid.drive.data.authentication.AuthenticationConstantsKt.SELECTED_ACCOUNT;
import static com.uteknoid.drive.lib.common.accounts.AccountUtils.Constants.OAUTH_SUPPORTED_TRUE;
        ...
        if (currentAccount != null) {
            ...
            if (currentAccountVersion == null) {
                ...
                for (Account account : ocAccounts) {
                    ...
                    username = com.uteknoid.drive.lib.common.accounts.AccountUtils.
                            getUsernameForAccount(account);
                    newAccountName = com.uteknoid.drive.lib.common.accounts.AccountUtils.
