...
import com.uteknoid.drive.operations.CopyFileOperation
import com.uteknoid.drive.operations.CreateFolderOperation
import com.uteknoid.drive.operations.MoveFileOperation
import com.uteknoid.drive.operations.RefreshFolderOperation
import com.uteknoid.drive.operations.RemoveFileOperation
import com.uteknoid.drive.operations.RenameFileOperation
import com.uteknoid.drive.operations.SynchronizeFileOperation
...
import com.uteknoid.drive.ui.fragment.FileDetailFragment
...
import com.uteknoid.drive.ui.helpers.FilesUploadHelper
import com.uteknoid.drive.ui.helpers.UriUploader
import com.uteknoid.drive.ui.preview.PreviewAudioFragment
import com.uteknoid.drive.ui.preview.PreviewImageActivity
import com.uteknoid.drive.ui.preview.PreviewImageFragment
import com.uteknoid.drive.ui.preview.PreviewTextFragment
import com.uteknoid.drive.ui.preview.PreviewVideoActivity
import com.uteknoid.drive.ui.preview.PreviewVideoFragment
                        ...
                        if (!synchResult?.isSuccess!!) {
                            ...
                            if (ResultCode.UNAUTHORIZED == synchResult.code ||
                                ...
                                launch(Dispatchers.IO) {
                                    val credentials =
                                        com.uteknoid.drive.lib.common.accounts.AccountUtils.getCredentialsForAccount(
                                            MainApp.appContext,
                                            account
                                        )
