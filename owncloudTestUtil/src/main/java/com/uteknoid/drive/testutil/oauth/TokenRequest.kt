 ...
 */
package com.uteknoid.drive.testutil.oauth

import com.uteknoid.drive.domain.authentication.oauth.model.TokenRequest
import com.uteknoid.drive.testutil.OC_BASE_URL
import com.uteknoid.drive.testutil.OC_CLIENT_AUTH
import com.uteknoid.drive.testutil.OC_REDIRECT_URI
import com.uteknoid.drive.testutil.OC_REFRESH_TOKEN
import com.uteknoid.drive.testutil.OC_TOKEN_ENDPOINT
