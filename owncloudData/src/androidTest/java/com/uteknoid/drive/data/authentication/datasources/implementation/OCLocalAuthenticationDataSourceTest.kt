...
import com.uteknoid.drive.data.authentication.KEY_CLIENT_REGISTRATION_CLIENT_EXPIRATION_DATE
import com.uteknoid.drive.data.authentication.KEY_CLIENT_REGISTRATION_CLIENT_ID
import com.uteknoid.drive.data.authentication.KEY_CLIENT_REGISTRATION_CLIENT_SECRET
import com.uteknoid.drive.data.authentication.KEY_OAUTH2_REFRESH_TOKEN
import com.uteknoid.drive.data.authentication.KEY_OAUTH2_SCOPE
...
import com.uteknoid.drive.lib.common.accounts.AccountUtils.Constants.ACCOUNT_VERSION
import com.uteknoid.drive.lib.common.accounts.AccountUtils.Constants.KEY_DISPLAY_NAME
import com.uteknoid.drive.lib.common.accounts.AccountUtils.Constants.KEY_OC_ACCOUNT_VERSION
import com.uteknoid.drive.lib.common.accounts.AccountUtils.Constants.KEY_OC_BASE_URL
import com.uteknoid.drive.lib.common.accounts.AccountUtils.Constants.KEY_OC_VERSION
import com.uteknoid.drive.lib.common.accounts.AccountUtils.Constants.KEY_SUPPORTS_OAUTH2
import com.uteknoid.drive.testutil.OC_ACCESS_TOKEN
import com.uteknoid.drive.testutil.OC_ACCOUNT
import com.uteknoid.drive.testutil.OC_ACCOUNT_ID
import com.uteknoid.drive.testutil.OC_ACCOUNT_NAME
import com.uteknoid.drive.testutil.OC_AUTH_TOKEN_TYPE
import com.uteknoid.drive.testutil.OC_BASE_URL
import com.uteknoid.drive.testutil.OC_BASIC_USERNAME
import com.uteknoid.drive.testutil.OC_OAUTH_SUPPORTED_TRUE
import com.uteknoid.drive.testutil.OC_REDIRECTION_PATH
import com.uteknoid.drive.testutil.OC_REFRESH_TOKEN
import com.uteknoid.drive.testutil.OC_SCOPE
